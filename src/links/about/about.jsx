        ...
        return(
            <div>
                ...
                <div className="jumbotron w-75 mx-auto text-justify" style={{fontSize:"25px"}}> 
                    ...
                    <p style={{marginTop:"3%"}}>
                        A ideia era construir um site para ajudar os servidores do Instituto com Licitações. Tudo o que é comprado ou contratado pelo IF, passa por uma licitação ou dispensa da mesma. Para isso,
