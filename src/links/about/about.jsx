...
class About extends React.Component{
    render(){
        return(
            <div>
                <h1 className="cover-heading title-about">Sobre o LicitaIF</h1>
                <div className="jumbotron w-75 mx-auto text-justify about-text"> 
                    ...
                    <div className="row w-100">
                        <div className="col-4 text-center col-tec">
